...
const AddPostNavigator = () => {
    return(
        <Stack.Navigator initialRouteName="AddPost" screenOptions={{headerTitle:null}}>
            <Stack.Screen name="AddPost" component={AddPostScreen} options={navAddPostOption.navigationOptions}/>
        </Stack.Navigator>
    )
}
